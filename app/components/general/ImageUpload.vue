    ...
    <div class="p-4 w-full rounded-xl bg-surface-variant flex items-center gap-x-3 transition-all duration-200">
      ...
      >
        <template v-if="previewUrl">
          ...
          />
          <div class="absolute inset-0 bg-black/30 opacity-0 hover:opacity-100 transition-opacity duration-200 flex items-center justify-center">
        ...
        <BIcon 
          v-else 
          icon="PhUserPlus" 
          class="w-6 h-6 fill-on-primary-container transition-opacity duration-200" 
        />
      </div>
